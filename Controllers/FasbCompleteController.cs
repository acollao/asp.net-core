...
{
    public class FasbCompleteController : Controller
    {
        ...
        public FasbCompleteController(IWebHostEnvironment environment, IConfiguration configuration, AppDBContext dbContext, UserManager<AppUser> userManager)
        {
        ...
        public async Task<IActionResult> Upload(List<IFormFile> postedFiles)
        {
            ...
            string[] allowedExtensions = { ".html", ".xhtml" };
